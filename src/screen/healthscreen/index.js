...
const HealthScreen = () => {
  ...
  const [selectedBloodPressureData, setSelectedBloodPressureData] = useState(null);
  ...
  const getColor = (data) => {
    ...
    return data[data.length - 1] > data[data.length - 2] ? `rgba(240, 0, 4, 1)` : `rgba(0, 76, 240, 1)`;
  };
    ...
    datasets: [
      {
        ...
        color: (opacity = 1) => getColor(createBloodPressureDataSet('systolic')), // Red color
        strokeWidth: 2
      },
      {
        data: createBloodPressureDataSet('diastolic'),
        color: (opacity = 1) => getColor(createBloodPressureDataSet('systolic')), // Blue color
        strokeWidth: 2
      }
    ],
    legend: []
        ...
        <>
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.graphBox}>
              ...
              <Text style={styles.analysisText}><FontAwesome5 name="info-circle" size={16} style={styles.iconStyle} /> 낮으면 신장 기능이 좋아요.</Text>
              <LineChart
                data={data1}
                width={screenWidth * 0.8}
                height={160}  // 줄여진 높이
                chartConfig={chartConfigWithGradient(createDataSet('resSerumCreatinine'))}
                bezier
                onDataPointClick={(data) => handleDataPointClick(data, createDataSet('resSerumCreatinine'), setSelectedData1)}
                style={styles.chart}
              />
              {selectedData1 && selectedData1.year && (
                <View style={[styles.dataPointInfo, { top: selectedData1.y +40, left: selectedData1.x  }]}>
            ...
            <View style={styles.graphBox}>
              ...
              <Text style={styles.analysisText}><FontAwesome5 name="info-circle" size={16} style={styles.iconStyle} /> 높으면 신장 기능이 좋아요.</Text>
              <LineChart
                data={data2}
                width={screenWidth * 0.8}
                height={160}  // 줄여진 높이
                ...
                bezier
                onDataPointClick={(data) => handleDataPointClick(data, createDataSet('resGFR'), setSelectedData2)}
                style={styles.chart}
              />
              {selectedData2 && selectedData2.year && (
                <View style={[styles.dataPointInfo, { top: selectedData2.y +40, left: selectedData2.x - 60 }]}>
                  <Text style={styles.dataPointInfoText}>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.graphBox}>
              ...
              <Text style={styles.analysisText}><FontAwesome5 name="info-circle" size={16} style={styles.iconStyle} /> 너무 낮으면 당뇨 위험이 높아요</Text>
              <LineChart
                data={data3}
                width={screenWidth * 0.8}
                height={160}  // 줄여진 높이
                chartConfig={chartConfigWithGradient(createDataSet('resFastingBloodSuger'))}
                bezier
                onDataPointClick={(data) => handleDataPointClick(data, createDataSet('resFastingBloodSuger'), setSelectedData3)}
                style={styles.chart}
              />
              {selectedData3 && selectedData3.year && (
                <View style={[styles.dataPointInfo, { top: selectedData3.y +40, left: selectedData3.x }]}>
                  <Text style={styles.dataPointInfoText}>
            ...
            <View style={styles.graphBox}>
              ...
              <Text style={styles.analysisText}><FontAwesome5 name="info-circle" size={16} style={styles.iconStyle} /> 높으면 고지혈증 위험이 높아요</Text>
              <LineChart
                data={data4}
                width={screenWidth * 0.8}
                height={160}  // 줄여진 높이
                chartConfig={chartConfigWithGradient(createDataSet('resTotalCholesterol'))}
                bezier
                onDataPointClick={(data) => handleDataPointClick(data, createDataSet('resTotalCholesterol'), setSelectedData4)}
                style={styles.chart}
              />
              {selectedData4 && selectedData4.year && (
                <View style={[styles.dataPointInfo, { top: selectedData4.y +40, left: selectedData4.x }]}>
                  <Text style={styles.dataPointInfoText}>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.graphBox}>
              ...
              <Text style={styles.analysisText}><FontAwesome5 name="info-circle" size={16} style={styles.iconStyle} /> 높을수록 고혈압 위험이 높아요</Text>
              <LineChart
                data={bloodPressureData}
                width={screenWidth * 0.8}
                height={160}  // 줄여진 높이
                chartConfig={chartConfigWithGradient(createBloodPressureDataSet('systolic'))}
                bezier
                onDataPointClick={(data) => handleDataPointClick(data, createBloodPressureDataSet('systolic'), setSelectedBloodPressureData)}
                style={styles.chart}
              />
              {selectedBloodPressureData && selectedBloodPressureData.year && (
                <View style={[styles.dataPointInfo, { top: selectedBloodPressureData.y +40, left: selectedBloodPressureData.x }]}>
                  <Text style={styles.dataPointInfoText}>
