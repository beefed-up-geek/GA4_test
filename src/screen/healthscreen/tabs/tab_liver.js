  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      <View style={styles.recordContainer}>
        ...
        <Text style={styles.value}>가장 최근 값: {latestRecord.resAST} {metrics_info.resAST.unit}</Text>
        <Text style={styles.analysis}>{analyzeMetric("resAST", parseFloat(latestRecord.resAST))}</Text>
      </View>
      
      <View style={styles.recordContainer}>
        <Text style={styles.title}>ALT</Text>
        <Text style={styles.value}>가장 최근 값: {latestRecord.resALT} {metrics_info.resALT.unit}</Text>
      ...
      <View style={styles.recordContainer}>
        ...
        <Text style={styles.value}>가장 최근 값: {latestRecord.resyGPT} {metrics_info.resyGPT.unit}</Text>
        <Text style={styles.analysis}>{analyzeMetric("resyGPT", parseFloat(latestRecord.resyGPT))}</Text>
      </View>
    </ScrollView>
  );
};
